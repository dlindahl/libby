...
By default, Libby will look in +public/javascripts+ for your the installed Javascript Libraries. If you wish to change the default path, put the following in an
...
Including a Javascript Library in your views or layouts can be as simple as the following commands:
